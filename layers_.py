...
#initializer = variance_scaling_initializer(factor=1.0,mode='FAN_AVG',uniform=True,dtype=tf.float32)
#initializer_relu = variance_scaling_initializer(factor=2.0,mode='FAN_IN',uniform=False,dtype=tf.float32)
